...
export function Iphone({ scale = 1, position = [0, 0, 0], rotation = [0, 0, 0], item, size }: IphoneModelProps) {

    const gltf = useGLTF('/models/scene.glb') as unknown as GLTFResult
  ...
  return (
    <group scale={scale} position={position} rotation={rotation} dispose={null}>
      ...
      <mesh
        ...
        scale={0.01}
      >
        <meshStandardMaterial map={texture} roughness={1} metalness={0.5}/>
      </mesh>
      <mesh
        castShadow
        receiveShadow
